...
import com.kotlin.ekstremeat.Adapter.MyCommentAdapter
import com.kotlin.ekstremeat.Callback.ICommentCallBack
...
class CommentFragment : BottomSheetDialogFragment(),ICommentCallBack {
    ...
    private fun loadCommentFromFirebase() {
     dialog!!.show()
        ...
        FirebaseDatabase.getInstance().getReference(com.kotlin.ekstremeat.Common.Common.COMMENT_REF)
            .child(com.kotlin.ekstremeat.Common.Common.foodSelected!!.id!!)
