...
import com.kotlin.ekstremeat.Remote.ICloudFunctions
import com.kotlin.ekstremeat.Remote.RetrofitCloudClient
...
class MainActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        userRef = FirebaseDatabase.getInstance().getReference(com.kotlin.ekstremeat.Common.Common.USER_REFERENCE)
    ...
    private fun showRegisterDialog(user:FirebaseUser) {
        ...
        builder.setPositiveButton("Register"){dialogInterface,i->
            ...
            userModel.address = edt_name.text.toString()
            userModel.phone = edt_name.text.toString()
    ...
    private fun goToHomeActivity(userModel: UserModel?) {
       com.kotlin.ekstremeat.Common.Common.currentUser = userModel!!
